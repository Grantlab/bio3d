...
test_that("eNMA works", {
  ...
  ## after minor bugfix related to addter=TRUE when calculating masses
  f1 <- c(0.2827600, 0.3139167, 0.3421285, 0.2781802, 0.2188650, 0.2739127)
  f2 <- c(0.2627269, 0.3043772, 0.3363984, 0.2731422, 0.2240850, 0.2610135)
  f3 <- c(0.5796615, 0.5201151, 0.4703789, 0.3598020, 0.2312163, 0.2843633)
