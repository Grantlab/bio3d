...
function (file, maxlines=-1, multi=FALSE,
  ...
  split.fields <- function(x) {
     ##- for data.frame fwf reading
     # split a string 'x' according to 'first' and 'last'
     # then re-combine wity "," sep
...
#  }
  ...
  ##- Insert records with atom[,"insert"] != NA
  if (rm.insert) {
