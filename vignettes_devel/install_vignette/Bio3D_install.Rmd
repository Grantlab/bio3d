...
author: "Xin-Qiu Yao, Lars Skjaerven & Barry J. rant"
...
Ubuntu repository:
    ...
    apt-get install r-base r-base-core netcdf-bin libnetcdf-dev libxml2-dev libcurl3-dev seaview muscle pymol 
...
Download the source code of the latest Bio3D version:
    ...
    wget http://thegrantlab.org/bio3d/phocadownload/Bio3D_version2.x/bio3d_2.1-0.tar.gz
...
install.packages("bio3d_2.1-0.tar.gz") 
```
...
*lattice*, *grid*, *bigmemory*, *XML*, *RCurl* and *igraph*. These can be
...
Or from the command line:
    ...
    R CMD INSTALL bio3d_2.1-0.tar.gz
