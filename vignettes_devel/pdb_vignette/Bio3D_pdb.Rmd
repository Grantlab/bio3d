...
Below we provide a basic example of such manipulation. We read in a multi-chained PDB structure in which we reassign the chain identifiers.  
...
write.pdb(pdb, xyz=xyz, chain=gs$grps, file="1d1d_fit-domain1.pdb")
```
