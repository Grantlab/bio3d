...
# Note that this is a numeric matrix 
# with 3N columns (each atom has three values (x, y and z))
# and number of rows corresponding to the number for models in the PDB file
