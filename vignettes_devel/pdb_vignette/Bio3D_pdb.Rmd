...
```{r, nma, results="hide", fig.cap="Results of ensemble normal mode analysis (NMA) plotted by function **plot.enma()**"}
## Quick NMA of all structures (see Figure 10)
modes <- nma(pdbs)
plot(modes, spread=TRUE)
