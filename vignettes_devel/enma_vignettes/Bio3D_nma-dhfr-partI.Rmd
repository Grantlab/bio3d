...
This document provides **Supporting Information S2** for *Integrating protein structural dynamics and evolutionary analysis with Bio3D*. The vignette is generated with **Bio3D version `r packageVersion("bio3d")`**. 
...
![Visualization of domain assignment using function **geostas()** for x-ray ensemble (left), ensemble NMA (middle), and MD trajectory (right).](figures/geostas-domains.png)
